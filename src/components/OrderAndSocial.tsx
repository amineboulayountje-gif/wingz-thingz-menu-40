...
const SnapchatIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
    <path d="M12 2c-3.3 0-5.5 2.2-5.5 5.5 0 2.3 1.2 3.7 1.2 5.2 0 .6-.6 1.1-1.2 1.1-.4 0-.8-.2-1.1.2-.3.4-.2.9.3 1.1 1.1.5 2.1.7 2.7 1.6.5.7.5 1.7-.6 2.4-.5.4-1.4.6-2.2.6-.6 0-1 .3-1 .8 0 .7 2.2 1.1 4.4 1.1 1.6 0 3.2-.6 4-1.7.8 1.1 2.4 1.7 4 1.7 2.2 0 4.4-.4 4.4-1.1 0-.5-.4-.8-1-.8-.8 0-1.7-.2-2.2-.6-1.1-.7-1.1-1.7-.6-2.4.6-.9 1.6-1.1 2.7-1.6.5-.2.6-.7.3-1.1-.3-.4-.7-.2-1.1-.2-.6 0-1.2-.5-1.2-1.1 0-1.5 1.2-2.9 1.2-5.2C17.5 4.2 15.3 2 12 2z"/>
  </svg>
);
