  ...
  return (
    <section className="py-10 sm:py-16 px-4">
      <div className="max-w-md mx-auto text-center space-y-6 sm:space-y-8">
        {/* Order Button */}
        <div>
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-display mb-3 sm:mb-4 text-gradient">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 sm:gap-3 bg-[#25D366] hover:bg-[#20bd5a] text-primary-foreground font-semibold text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 rounded-lg transition-all duration-300 hover:scale-105 shadow-lg"
          >
